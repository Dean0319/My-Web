...
export const ppt0305ImageMap = [
  ...
  {
    src: "/showcase/ppt-0305/image1.png",
    alt: "场地与节点连线（示例）",
    topicId: "location",
    caption: "区位关系/节点串联的图示表达方式",
  },
  {
    src: "/showcase/ppt-0305/image17.jpeg",
    alt: "人群密度、周边用地、交通（示例）",
    topicId: "location",
    caption: "用‘密度圈层 + 周边功能泡泡 + 道路结构’讲清楚区位",
  },
  {
    src: "/showcase/ppt-0305/image9.png",
    alt: "空间策略/站城理念（示例）",
    topicId: "location",
  ...
  // 历史与遗产
  {
    src: "/showcase/ppt-0305/image2.png",
    alt: "历史沿革时间轴（示例）",
    topicId: "history",
    caption: "用时间轴组织关键事件/政策/空间变化",
  },
  {
    src: "/showcase/ppt-0305/image3.png",
    alt: "形态演变（示例）",
    topicId: "history",
    caption: "用‘阶段-形态-照片’讲清楚格局变迁",
  },
  {
    src: "/showcase/ppt-0305/image4.jpeg",
    alt: "风貌保护与街巷格局（示例）",
    topicId: "history",
  ...
  // 交通与慢行
  {
    src: "/showcase/ppt-0305/image5.jpeg",
    alt: "道路交通系统规划（示例）",
    topicId: "transport",
    caption: "道路等级、慢行、公交、停车的综合表达",
  },
  {
    src: "/showcase/ppt-0305/image6.png",
    alt: "道路与交通组成分析（示例）",
    topicId: "transport",
    caption: "用箭头 + 注释说明出行方式与可达性问题",
  },
  {
    src: "/showcase/ppt-0305/image7.png",
    alt: "交通策略分图（示例）",
    topicId: "transport",
    caption: "步行/公交/机动车/骑行分别成图，最后汇总策略",
  },
  {
    src: "/showcase/ppt-0305/image16.jpeg",
    alt: "慢行游线与界面观察（示例）",
    topicId: "transport",
  ...
  // 开敞空间
  {
    src: "/showcase/ppt-0305/image8.png",
    alt: "周边公共绿地与连通（示例）",
    topicId: "open-space",
  ...
  // 功能与用地
  {
    src: "/showcase/ppt-0305/image10.png",
    alt: "用地布局/功能分区（示例）",
    topicId: "function",
  ...
  // 建筑与风貌
  {
    src: "/showcase/ppt-0305/image13.jpeg",
    alt: "建筑层数/质量/年代评价（示例）",
    topicId: "building",
    caption: "用分级评价支持‘保留/更新/改造’判断",
  },
  {
    src: "/showcase/ppt-0305/image14.jpeg",
    alt: "天际线与界面（示例）",
    topicId: "building",
  ...
  // 活力与人群
  {
    src: "/showcase/ppt-0305/image12.jpeg",
    alt: "人群与活动时段需求（示例）",
    topicId: "vitality",
